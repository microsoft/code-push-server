...
export type StorageItem = {
  ...
  accessKeys: { [id: string]: AccessKey };
  deploymentKeys: { [id: string]: string };
  accountToAppsMap: { [id: string]: string[] };
  appToAccountMap: { [id: string]: string };
  emailToAccountMap: { [email: string]: string };
  appToDeploymentsMap: { [id: string]: string[] };
  deploymentToAppMap: { [id: string]: string };
  deploymentKeyToDeploymentMap: { [id: string]: string };
  accountToAccessKeysMap: { [id: string]: string[] };
  accessKeyToAccountMap: { [id: string]: string };
  accessKeyNameToAccountIdMap: { [accessKeyName: string]: { accountId: string; expires: number } };
};
...
export interface Storage {
  ...
  addDeployments(accountId: string, appId: string, deployments: Deployment[]): Promise<string[]>;
